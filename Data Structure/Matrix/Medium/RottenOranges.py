...
go through the matrix and add the rotten oranges into the queue

if the queue is empty or when there are no more fresh oranges then return the time

if there are any fresh oranges left that cant be reached then return -1
