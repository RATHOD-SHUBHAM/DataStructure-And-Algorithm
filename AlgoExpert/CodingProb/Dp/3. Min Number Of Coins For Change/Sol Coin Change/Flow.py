'''
# https://leetcode.com/problems/coin-change/discuss/3141764/Brute-Force-to-Optimal-or-Python
...
Base Case Logic:
    We return a 0 or inf, because we are trying to find min number.
    1. Return 0 -  if we are able to reach target
    2. Return inf - If we could not reach target.
    * this happens when
