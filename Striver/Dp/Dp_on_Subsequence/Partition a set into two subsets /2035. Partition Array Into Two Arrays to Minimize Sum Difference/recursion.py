class Solution:
    def minimumDifference(self, nums: List[int]) -> int:
        ...
        return self.recursion(idx, count, current_sum, m, n, total, nums)

        
    def recursion(self, idx, count, current_sum, m, n, total, nums):
        # Base case
        ...
        take = self.recursion(idx - 1, count + 1, current_sum + nums[idx], m, n, total, nums)
        
        # Include in array2 (don't add to current_sum)
        no_take = self.recursion(idx - 1, count, current_sum, m, n, total, nums)
